package com.zmm.dynamicsearchlist;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getmData(ArrayList<Map<String, Object>> mDatas)
    {
        ...
        mListTitle.add("这是第二个标题!");
        mListText.add("这是第二个文本.\n2014.09.18.19.52");
        ...
        mListTitle.add("这是第三个标题!");
        mListText.add("这是第三个文本.\n2014.09.18.19.53");
        ...
        mListTitle.add("这是第四个标题!");
        mListText.add("这是第四个文本.\n2014.09.18.19.54");
